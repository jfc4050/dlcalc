...
class TestTensorRepr:
    ...
    def test_unpartitioned_shape_and_numel(self):
        ...
        tensor = TensorRepr(
            unpartitioned_shape=(100, 200, 300),
            partition_spec={},
            bits_per_elt=32
        )
    ...
    def test_high_dimensional_tensor(self):
        ...
        tensor = TensorRepr(
            unpartitioned_shape=shape,
            partition_spec={0: 2, 3: 5, 7: 3},
            bits_per_elt=8
        )
    ...
    def test_partition_spec_with_large_degrees(self):
        ...
        tensor = TensorRepr(
            unpartitioned_shape=(10000, 20000),
            partition_spec={0: 100, 1: 200},
            bits_per_elt=16
        )
...
class TestIntegration:
    ...
    def test_tensor_size_operations(self):
        ...
        tensor1 = TensorRepr(
            unpartitioned_shape=(100, 100),
            partition_spec={},
            bits_per_elt=16
        )
        tensor2 = TensorRepr(
            unpartitioned_shape=(50, 50),
            partition_spec={},
            bits_per_elt=16
        )
